...
export const POWER_GUIDANCE: Record<EntitlementId, PowerGuidance> = {
  collect_cash: {
    purpose: "Accept patient funds and operate the physical or virtual cash drawer.",
  ...
  post_payments: {
    purpose: "Apply patient and insurer receipts to the correct ledger and encounter.",
    evidence: "PMS posting batch tied to remittance or receipt",
  ...
  bank_reconcile: {
    purpose: "Independently match bank activity to PMS and accounting records.",
  ...
  post_adjustments: {
    purpose: "Record approved credits, write-offs, and corrections in the patient ledger.",
  ...
  pms_admin_roles: {
    purpose: "Configure PMS roles, permissions, and privileged settings.",
  ...
  issue_refunds: {
    purpose: "Send an approved patient credit back through an authorized channel.",
  ...
  change_fee_schedule: {
    ...
    boundary: "Changes require clinical or owner approval and retrospective review.",
  },
  edit_patient_master: {
    purpose: "Maintain patient identity, guarantor, coverage, and contact records.",
    evidence: "PMS audit trail and source documentation",
    boundary: "Sensitive identity and guarantor changes should be logged and reviewed.",
  },
  manage_user_access: {
  ...
  export_bulk_data: {
    purpose: "Extract patient, clinical, or financial data outside normal screens.",
  ...
  order_supplies: {
    purpose: "Commit the practice to approved goods or services.",
