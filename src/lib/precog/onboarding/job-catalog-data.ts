...
const RAW_CATALOG: readonly Omit<JobCatalogEntry, "description">[] = [
  ...
  entry(
    ...
    "The owner is the approver of last resort, usually the one who signs, and the one who approves the team's expense claims and card spending. Tick Spend on a company card if you hold one yourself. Reconciling the bank is left for you to tick: tick it if you check the statement against the books yourself. So is giving people logins to the bank and the books: in the tested businesses most owners, partners and co-founders did not.",
  ),
  entry(
    "general-manager",
  ...
  entry(
    ...
    "A restaurant manager closes the drawer, makes the deposit, approves voids and comps, submits timecards, orders and receives goods, and holds the house card for the runs the suppliers do not cover.",
  ),
  entry(
    "assistant-manager",
  ...
  entry(
    ...
    "An accountant posts entries, codes the card statements, and reconciles; whether the same person also pays is the question the map answers.",
    "13-2011",
  ),
  entry(
    "bookkeeper",
  ...
  entry(
    ...
    "A director takes tuition, makes the deposit, approves suppliers, buys supplies on the center's card, and submits hours, usually with no one above them on site.",
  ),
  entry(
    "assistant-director",
  ...
  entry(
    ...
    "A fleet manager approves fuel, repair, and equipment suppliers, holds the fuel and repair cards, and submits drivers' hours.",
  ),
  entry(
    "project-accountant",
  ...
  entry(
    ...
    "A service manager approves goodwill and warranty write-offs, submits the technicians' hours, orders and receives parts, and holds the shop card for sublet and outside purchases.",
  ),
  entry(
    "automotive-support",
