  ...
  processes: [
    {
      ...
      ideas: [
        ...
        },
        {
          ...
          effort: "low",
          impact: "medium",
          note: "The store manager shadows the lead cashier for two closes; write a one-page returns cheat sheet.",
          status: "backlog",
        },
      ],
      wastes: [
    ...
    },
    {
      ...
      risks: [
        ...
        },
        {
          ...
          severity: 3,
          likelihood: 3,
          note: "Often only the inventory lead runs cycle counts; shrink goes unmeasured when they are out.",
    ...
    },
    {
      ...
      ideas: [
        ...
        },
        {
          ...
          effort: "low",
          impact: "high",
          note: "Simple threshold; anything above it needs the owner's initials.",
          status: "exploring",
        },
      ],
      wastes: [
      ...
      risks: [
        {
          ...
          severity: 4,
          likelihood: 2,
          note: "The store manager enters payroll and can adjust punches with no second look before export.",
        },
        {
          id: "r-pay-2",
      ...
      ideas: [
        {
          ...
          effort: "low",
          impact: "high",
          note: "The owner reviews the hours and commission summary each period.",
          status: "planned",
        },
        {
          id: "i-pay-2",
