...
export const KNOWLEDGE_CORPUS: KnowledgeChunk[] = [
  ...
  // ---- Professional services ----
  {
    ...
    tags: ["professional services", "trust account", "iolta", "retainer", "commingling", "three-way reconciliation"],
  ...
  // ---- General small business ----
  {
    ...
    text: "The single highest-ROI control for a small business is the owner opening the bank statement first and reviewing every check image and ACH before handing it to the bookkeeper. Add positive pay (the bank only honors checks you pre-authorize) and dual approval on ACH above a threshold, and most embezzlement paths close.",
