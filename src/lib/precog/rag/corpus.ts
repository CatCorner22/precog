...
const GAO_GREEN_BOOK: ChunkBasis = {
  kind: "cited",
  publisher: "U.S. Government Accountability Office",
  document:
    "Standards for Internal Control in the Federal Government (the Green Book, 2025 revision)",
  url: "https://www.gao.gov/products/gao-25-107721",
};
const NIST_CSF: ChunkBasis = {
  kind: "cited",
  publisher: "National Institute of Standards and Technology",
  document: "Cybersecurity Framework 2.0",
  url: "https://www.nist.gov/cyberframework",
};
const HHS_HIPAA_RISK: ChunkBasis = {
  kind: "cited",
  publisher: "U.S. Department of Health and Human Services, Office for Civil Rights",
  document: "Guidance on Risk Analysis under the HIPAA Security Rule",
  url: "https://www.hhs.gov/hipaa/for-professionals/security/guidance/guidance-risk-analysis/index.html",
};
const FBI_BEC: ChunkBasis = {
  kind: "cited",
  publisher: "Federal Bureau of Investigation",
  document: "Business Email Compromise (Scams and Safety)",
...
export const KNOWLEDGE_CORPUS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    basis: practice("Payroll change-control practice for a small business."),
  },
  {
  ...
  },
  {
    ...
    basis: practice(
      "Management-override practice: the owner's own transactions are the ones nobody else reviews.",
    ),
  },
];
