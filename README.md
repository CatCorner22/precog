...
| **Decision journal**    | Document accept / remediate / monitor / insure with review dates; each entry snapshots scores when logged and again at review (then-vs-now), including register coverage for decisions logged from the continuity planner                                                                                                                                                                                                                                                                                                                             |
