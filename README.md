...
See [`docs/COMMERCIAL_VALIDATION_PLAN.md`](docs/COMMERCIAL_VALIDATION_PLAN.md) for the 12-week customer-research program, competitor benchmark protocol, paid-pilot experiments, engineering review plan, commercial scorecard, and evidence-based go/narrow/stop decision.
